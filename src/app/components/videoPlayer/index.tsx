...
const MovieList = () => {
  ...
  return (
    <div className="p-6 w-100 bg-gray-900  text-white">
      <h1 className="text-4xl font-bold text-center mb-10">Movies</h1>
      <div className="flex flex-col items-center justify-center p-4 bg-gray-800 rounded-xl shadow hover:shadow-lg transition mb-10 max-w-md mx-auto">
        ...
        <label htmlFor="imdb-id" className="mt-4 text-sm text-gray-400">
